...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("resources/hPointLight.vs", "resources/hPointLight.fs");
    ...
    unsigned int emissionMap = loadTexture(std::string("resources/matrix.jpg").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // --------------------
        double seconds = static_cast<float>(glfwGetTime());
        ...
        // CHANGE lightPos
        float radius = 2.0f;
        float lightX = cos(seconds) * radius;
        float lightY = sin(seconds * 3) * radius;
        float lightZ = sin(seconds) * radius;
        ...
        lightingShader.setFloat("time", seconds);
